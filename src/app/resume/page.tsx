...
import { Download, GraduationCap, Code2, Database, Globe, Layers, ArrowLeft, Briefcase, Award } from "lucide-react";
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
                <div className="container mx-auto px-6 max-w-5xl py-8 pt-12">
                    <Link
                        href="/"
                        ...
                        {experience.map((exp, i) => (
                            <div key={i} className="flex gap-4">
                                <div className="flex flex-col items-center">
                                    ...
                                    {i < experience.length - 1 && <div className="w-0.5 h-full bg-gray-200 mt-1" />}
                                </div>
                                <div className="pb-2">
                                    <h4 className="font-bold text-gray-900">{exp.role}</h4>
                                    <p className="text-sm text-blue-600 font-medium mb-1">{exp.company} • {exp.period}</p>
